...
#-----------------------
# This file contains Sections 3.1 and 3.2 of QN-MHP 4/26/24 (L2097-2437)
# for showing the Window (Canvas) and Layout/structure of QN-MHP
...
#3.2 structure and animation (Q: animation is also 3.2? Or only in 3.3?)
...
class Structure_and_Animation:   
    ...
    def  background (self):
        ...
        Cache.append({'name':'A_C','location':[12.2,7.5,12.7,8]})
        Cache.append({'name':'B_C','location':[12.2,8,12.7,8.5]})
        Cache.append({'name':'D_C','location':[13.3,7.1,13.7,7.5]})
        Cache.append({'name':'F_C','location':[13.2,8.5,13.7,9]})
        Cache.append({'name':'Y_C','location':[12.7,8.5,13.2,9]})
        ...
        links.append({'name':'X_W','location':[20, 11.2, 19.3, 11.2, 19.3, 6.4,20, 6.4],'arrows':'1x'}) 
